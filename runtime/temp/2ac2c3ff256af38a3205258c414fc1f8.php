...
<div class="layui-form">
    <table class="layui-table lay-even">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo url('AdminExpandField/index',array('group_id'=>$vo['group_id'])); ?>" class="layui-btn layui-btn-mini modal-catch">
