<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"F:\wamp64\www\1kblite\public/../application/article\view\admin_content\index.html";i:1504851547;s:79:"F:\wamp64\www\1kblite\public/../application/admin\view\public\base_content.html";i:1506321128;s:73:"F:\wamp64\www\1kblite\public/../application/admin\view\public\common.html";i:1504851547;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <section class="panel panel-padding" style="height:40px;margin-bottom:4px">
                <div class="group-button">
                    ...
                    <a href="<?php echo $vo['url']; ?>" class="layui-btn layui-btn-small <?php if(stristr($vo['url'],str_replace('.html','',url()))): ?>layui-btn-danger<?php else: endif; ?>"><?php echo $vo['name']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; endif; if(!(empty($infoModule['_info']['1']) || (($infoModule['_info']['1'] instanceof \think\Collection || $infoModule['_info']['1'] instanceof \think\Paginator ) && $infoModule['_info']['1']->isEmpty()))): if(is_array($infoModule['_info']) || $infoModule['_info'] instanceof \think\Collection || $infoModule['_info'] instanceof \think\Paginator): if( count($infoModule['_info'])==0 ) : echo "" ;else: foreach($infoModule['_info'] as $key=>$vo): if(!(empty($vo['function']) || (($vo['function'] instanceof \think\Collection || $vo['function'] instanceof \think\Paginator ) && $vo['function']->isEmpty()))): ?>
                            <a class="layui-btn layui-btn-small <?php if(stristr($vo['url'],str_replace('.html','',url()))): ?>layui-btn-danger<?php else: endif; ?> ajax" data-params='{"url": "<?php echo $vo['url']; ?>","data":"","confirm":"false","complete":"up"}' style="float:right;"><?php echo $vo['name']; ?></a>
                        <?php else: ?>
                            <a href="<?php echo $vo['url']; ?>" class="layui-btn layui-btn-small <?php if(stristr($vo['url'],str_replace('.html','',url()))): ?>layui-btn-danger<?php else: endif; ?>" style="float:right;">
                            <?php echo $vo['name']; ?>
                            </a>
                        <?php endif; endforeach; endif; else: echo "" ;endif; else: if(!(empty($infoModule['_info']['0']) || (($infoModule['_info']['0'] instanceof \think\Collection || $infoModule['_info']['0'] instanceof \think\Paginator ) && $infoModule['_info']['0']->isEmpty()))): if(!(empty($vo['function']) || (($vo['function'] instanceof \think\Collection || $vo['function'] instanceof \think\Paginator ) && $vo['function']->isEmpty()))): ?>
                                <a class="layui-btn layui-btn-small <?php if(stristr($vo['url'],str_replace('.html','',url()))): ?>layui-btn-danger<?php else: endif; ?> ajax"  target="<?php echo (isset($infoModule['_info'][0]['target']) && ($infoModule['_info'][0]['target'] !== '')?$infoModule['_info'][0]['target']:''); ?>" data-params='{"url": "<?php echo $infoModule['_info'][0]['url']; ?>","data":"","confirm":"false","complete":"up"}' style="float:right;"><?php echo $infoModule['_info'][0]['name']; ?></a>
                            <?php else: ?>
                                <a href="<?php echo $infoModule['_info'][0]['url']; ?>" target="<?php echo (isset($infoModule['_info'][0]['target']) && ($infoModule['_info'][0]['target'] !== '')?$infoModule['_info'][0]['target']:''); ?>" class="layui-btn layui-btn-small <?php if(stristr($vo['url'],str_replace('.html','',url()))): else: ?>layui-btn-danger<?php endif; ?>" style="float:right">
