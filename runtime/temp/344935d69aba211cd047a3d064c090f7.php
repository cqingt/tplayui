                ...
                <form id="form1" class="layui-form layui-form-pane" action="<?php echo url(''); ?>">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select class="tpl-form-input" name="group_id">
                                ...
                                <option value="<?php echo $vo['group_id']; ?>" <?php if($vo['group_id'] == $info['group_id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="username" value="<?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?>" jq-verify="" jq-error=" 请输入用户名/登录名" placeholder="请输入用户名/登录名" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">昵称</label>
                        <div class="layui-input-block">
                            <input type="text" name="nicename" value="<?php echo (isset($info['nicename']) && ($info['nicename'] !== '')?$info['nicename']:''); ?>" jq-verify="" jq-error="请输入昵称" placeholder="请输入昵称" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">邮箱</label>
                        <div class="layui-input-block">
                            <input type="text" name="email" value="<?php echo (isset($info['email']) && ($info['email'] !== '')?$info['email']:''); ?>" jq-verify="" jq-error="请输入邮箱" placeholder="请输入邮箱" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">密码</label>
                        <div class="layui-input-block">
                            <input type="password" name="password" jq-verify="" jq-error="请输入密码，不修改请留空" placeholder="请输入密码，不修改请留空" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">密码</label>
                        <div class="layui-input-block">
                            <input type="password" name="password2" jq-verify="" jq-error="重复刚才输入的密码" placeholder="重复刚才输入的密码" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    ...
                    <div class="layui-input-block">
                        <input type="hidden" name="user_id" type="hidden" value="<?php echo (isset($info['user_id']) && ($info['user_id'] !== '')?$info['user_id']:''); ?>">
