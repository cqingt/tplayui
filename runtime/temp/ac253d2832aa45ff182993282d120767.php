                    ...
                    <div class="am-u-sm-12">
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                            ...
                            <tr class="gradeX">
                                ...
                                <td><?php if(empty($vo['verify_data']) || (($vo['verify_data'] instanceof \think\Collection || $vo['verify_data'] instanceof \think\Paginator ) && $vo['verify_data']->isEmpty())): ?>不验证<?php else: ?>验证<?php endif; ?></td>
                                <td>
                                    <div class="tpl-table-black-operation">
                                        <a href="<?php echo url('edit',array('field_id'=>$vo['field_id'],'fieldset_id'=>$vo['fieldset_id'])); ?>">
                                            <i class="am-icon-pencil"></i> 编辑
                                        </a>
                                        <a href="javascript:;" class="tpl-table-black-operation-del" onclick="del(this,'<?php echo $vo['field_id']; ?>','<?php echo url('del'); ?>')" >
