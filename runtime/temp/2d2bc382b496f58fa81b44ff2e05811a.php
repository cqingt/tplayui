<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"F:\wamp64\www\1kbcms2\public/../application/admin\view\index\index.html";i:1500538495;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <div class="jqadmin-logo-box">
            <a class="logo" href="http://jqadmin.jqcool.net" title="jQAdmin"><img src="__ADMIN__/images/logo.png" alt=""></a>
        ...
        <div class="layui-tab layui-tab-card jqadmin-tab-box" id="jqadmin-tab" lay-filter="tabmenu" lay-notAuto="true">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe class="jqadmin-iframe" data-id='0' src="<?php echo url('home'); ?>"></iframe>
                </div>
            </div>
        </div>
    </div>
