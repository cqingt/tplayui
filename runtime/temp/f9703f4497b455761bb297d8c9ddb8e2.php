<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp64\www\1kbcms2\public/../application/admin\view\setting\site.html";i:1500992118;s:79:"D:\wamp64\www\1kbcms2\public/../application/admin\view\public\base_content.html";i:1500899445;s:73:"D:\wamp64\www\1kbcms2\public/../application/admin\view\public\common.html";i:1500988625;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <form id="form1" class="layui-form layui-form-pane" action="<?php echo url(''); ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="site_title" value="<?php echo (isset($info['site_title']) && ($info['site_title'] !== '')?$info['site_title']:''); ?>" jq-verify="" jq-error=" 请输入站点标题" placeholder="请输入站点标题" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">站点副标题</label>
                        <div class="layui-input-block">
                            <input type="text" name="site_subtitle" value="<?php echo (isset($info['site_subtitle']) && ($info['site_subtitle'] !== '')?$info['site_subtitle']:''); ?>" jq-verify="" jq-error=" 请输入站点副标题" placeholder="请输入站点标题" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">站点关键词</label>
                        <div class="layui-input-block">
                            <input type="text" name="site_keywords" value="<?php echo (isset($info['site_keywords']) && ($info['site_keywords'] !== '')?$info['site_keywords']:''); ?>" jq-verify="" jq-error=" 请输入站点关键词" placeholder="请输入站点标题" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item ">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="site_url" value="<?php echo (isset($info['site_url']) && ($info['site_url'] !== '')?$info['site_url']:''); ?>" jq-verify="" jq-error=" 请输入站点网址" placeholder="请输入站点标题" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">站长邮箱</label>
                        <div class="layui-input-block">
                            <input type="text" name="site_email" value="<?php echo (isset($info['site_email']) && ($info['site_email'] !== '')?$info['site_email']:''); ?>" jq-verify="" jq-error=" 请输入站长邮箱" placeholder="请输入站点标题" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">站点版权</label>
                        <div class="layui-input-block">
                            <input type="text" name="site_copyright" value="<?php echo (isset($info['site_copyright']) && ($info['site_copyright'] !== '')?$info['site_copyright']:''); ?>" jq-verify="" jq-error=" 请输入站点版权" placeholder="请输入站点标题" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
