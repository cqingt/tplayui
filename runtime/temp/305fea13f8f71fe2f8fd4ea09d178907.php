<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"F:\wamp64\www\1kbcms2\public/../application/admin\view\user\index.html";i:1501660235;s:79:"F:\wamp64\www\1kbcms2\public/../application/admin\view\public\base_content.html";i:1501480671;s:73:"F:\wamp64\www\1kbcms2\public/../application/admin\view\public\common.html";i:1501032406;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layui-form">
    <table class="layui-table lay-even">
        ...
        <tr>
            ...
            <td><input type="checkbox" name="field_value" lay-skin="switch" value="1" lay-text="正常|禁用" <?php if($vo['status'] == '1'): ?>checked<?php endif; ?>  lay-filter="ajax" data-params='{"url":"<?php echo url("api/api/upField"); ?>","confirm":"true","data":"table=user&id_name=user_id&id_value=<?php echo $vo['user_id']; ?>&field=status","complete":"up"}'></td>
            <td>
                <a href="<?php echo url('info',array('user_id'=>$vo['user_id'])); ?>" class="layui-btn layui-btn-mini modal-catch">
                    <i class="iconfont">&#xe653;</i>编辑
                </a>
                <a class="layui-btn layui-btn-mini layui-btn-danger ajax"
                   data-list='{"key":"id=<?php echo $vo['user_id']; ?>","msg":true,"render":"true","action":"del"}'
                   data-params='{"url": "<?php echo url("del"); ?>","confirm":"true","data":"id=<?php echo $vo['user_id']; ?>","complete":"del"}'>
