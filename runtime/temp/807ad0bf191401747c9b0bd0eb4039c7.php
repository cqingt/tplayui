...
<div class="layui-form">
    <table class="layui-table lay-even">
        ...
        <tr>
            ...
            <td><input type="checkbox" name="field_value" lay-skin="switch" value="1" lay-text="正常|禁用" <?php if($vo['status'] == '1'): ?>checked<?php endif; ?>  lay-filter="ajax" data-params='{"url":"<?php echo url("api/api/upField"); ?>","confirm":"true","data":"table=admin_user&id_name=user_id&id_value=<?php echo $vo['user_id']; ?>&field=status","complete":"up"}'></td>
            <td>
