...
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COMMENT='后台操作记录';
...
-- ----------------------------
INSERT INTO `ykb_admin_menu` VALUES ('10', '0', '首页', '', '#xe610;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('11', '10', '管理首页', '/admin/index/home.html', '#xe64c;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('12', '10', '后台菜单', '/admin/admin_menu/index.html', '#xe635;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('20', '0', '内容', '', '#xe637;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('21', '20', '栏目管理', '/kbcms/admin_category/index.html', '#xe635;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('22', '20', '文章管理', '/article/admin_content/index.html', '#xe62a;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('30', '0', '表单', '', '#xe64a;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('40', '0', '功能', '', '#xe637;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('31', '40', '碎片管理', '/kbcms/admin_fragment/index.html', '#xe611;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('32', '40', '推荐位管理', '/kbcms/admin_position/index.html', '#xe62a;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('33', '40', '扩展模型管理', '/kbcms/admin_expand/index.html', '#xe62a;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('34', '40', '表单管理', '/kbcms/admin_form/index.html', '#xe62a;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('50', '0', '系统', '', '#xe646;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('51', '50', '系统设置', '/admin/setting/site.html', '#xe689;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('52', '50', '后台用户', '/admin/admin_user/index.html', '#xe672;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('53', '50', '后台用户组', '/admin/admin_user_group/index.html', '#xe668;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('54', '50', '会员管理', '/admin/user/index.html', '#xe608;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('55', '50', '会员类型', '/admin/user_type/index.html', '#xe630;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('60', '0', '插件中心', '', '#xe637;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('61', '60', '插件管理', '', '#xe62a;', '1');
INSERT INTO `ykb_admin_menu` VALUES ('611', '61', '插件工具', '/plug/plugin/index.html', '#xe62a;', '1');
...
-- ----------------------------
INSERT INTO `ykb_admin_user` VALUES ('1', '1', 'admin', 'eff938d0cb3a9e7c2a3ed097acb0d64e', '管理员', '529988248@qq.com', '1', '1', '1399361747', '1501809624', '::1');
...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='栏目基础信息';

-- ----------------------------
-- Records of ykb_category
-- ----------------------------
INSERT INTO `ykb_category` VALUES ('20', '0', 'page', '1', '2', '1', '关于我们', 'guanyuwomen', '', '/uploads/admin/20170419/8cb36838cc73b0bfdceff8f2c043b743.jpg', 'page', '', '徽隆公司2010年创立于上海市松江区，这里历史悠久,历史上曾有“苏（苏州府）松（松江府）财赋半天下”之美誉；这里风景秀丽，名胜众多，有“唐宋元明清，从古至今“之誉，这里交通便利，地理位置特殊而重要。', '1', '', '0');
INSERT INTO `ykb_category` VALUES ('59', '0', 'article', '1', '1', '1', '新闻资讯', '', '', '', 'list', '', '', '1', '', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=140 DEFAULT CHARSET=utf8 COMMENT='内容基础';

-- ----------------------------
-- Records of ykb_content
-- ----------------------------
INSERT INTO `ykb_content` VALUES ('133', '59', '守得初心自清宁，扪心无愧如坦途', '', null, null, null, '1', null, '阿萨达', '1497231583', '', '', null, '0', '1', null, '24', '0', '', '1', '0');
INSERT INTO `ykb_content` VALUES ('134', '59', '任岁月变迁，我心不惊', '', null, null, null, null, null, '', '1497259707', '', '', null, '0', '1', null, '1', '0', '', '1', '0');
INSERT INTO `ykb_content` VALUES ('137', '59', '时光且长，一切都来得及', '', null, null, null, '2', null, '', '1497259621', '', '', null, '0', '1', null, '4', '0', '', '1', '0');
INSERT INTO `ykb_content` VALUES ('138', '59', '不殆时间，不负自己', '', null, null, null, null, null, '', '1497259940', '', '', null, '0', '1', null, '9', '0', '', '1', '0');
INSERT INTO `ykb_content` VALUES ('139', '59', '相遇文字，相遇你', '', null, null, null, null, null, '', '1501662959', '', '', null, '0', '1', null, '3', '0', '', '1', '0');
...
CREATE TABLE `ykb_fragment` (
  ...
  KEY `label` (`label`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='网站碎片';
...
-- Records of ykb_user
-- ----------------------------
INSERT INTO `ykb_user` VALUES ('1', null, 'e10adc3949ba59abbe56e057f20f883e', '/uploads/home/20170802/4991a27914d770eaded6eab73786b54a.jpg', '壹凯', '529988248@qq.com', '大连高新园区', '1', '122222', '1', '1', '1501662959', '1501640518', '::1');
