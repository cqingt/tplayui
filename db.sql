...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='后台操作记录';

-- ----------------------------
-- Records of ykb_admin_log
-- ----------------------------
INSERT INTO `ykb_admin_log` VALUES ('1', '0', '1515035194', '::1', 'admin', '登录系统');
INSERT INTO `ykb_admin_log` VALUES ('2', '0', '1528257922', '::1', 'admin', '登录系统');
INSERT INTO `ykb_admin_log` VALUES ('3', '0', '1528263447', '127.0.0.1', 'admin', '登录系统');
...
-- ----------------------------
INSERT INTO `ykb_admin_user` VALUES ('1', '1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '管理员', '529988248@qq.com', '1', '1', '1399361747', '1528263447', '127.0.0.1');
...
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='栏目基础信息';
...
INSERT INTO `ykb_category` VALUES ('67', '59', 'article', '1', '0', '1', '射雕英雄传', '', '', '', 'list', '', '', '1', '', '0', '1');
...
INSERT INTO `ykb_category_article` VALUES ('67', '0', 'content', null, '', '10');
...
) ENGINE=InnoDB AUTO_INCREMENT=146 DEFAULT CHARSET=utf8 COMMENT='内容基础';

-- ----------------------------
-- Records of ykb_content
-- ----------------------------
INSERT INTO `ykb_content` VALUES ('133', '59', '守得初心自清宁，扪心无愧如坦途', '', null, null, null, '1', null, '阿萨达', '1497231583', '', '', null, '0', '1', null, '57', '0', '', '1', '0');
...
INSERT INTO `ykb_content` VALUES ('139', '59', '相遇文字，相遇你', '', null, null, null, null, null, '', '1501662959', null, '', null, '0', '1', null, '30', '0', '', '1', '0');
...
INSERT INTO `ykb_content` VALUES ('145', '59', '用户名或密码错误', '', null, null, null, null, null, '', '1528263583', '', '', null, '0', '1', null, '3', '0', '', '1', '0');
...
INSERT INTO `ykb_content_article` VALUES ('145', '');
...
INSERT INTO `ykb_ext_news` VALUES ('145', '作者');
...
CREATE TABLE `ykb_file` (
  ...
  KEY `ext` (`ext`),
  KEY `time` (`time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='上传文件';

-- ----------------------------
-- Records of ykb_file
-- ----------------------------
INSERT INTO `ykb_file` VALUES ('1', '/uploads/admin/20180606/22f8c8a0fbe99a2a7c990b184359192b.png', '/uploads/admin/20180606/22f8c8a0fbe99a2a7c990b184359192b.png', null, 'png', '275474', '1528264430');
INSERT INTO `ykb_file` VALUES ('2', '/uploads/home/20180606/a3cec8e81ecc1c15b63a0a1cfec311c5.png', '/uploads/home/20180606/a3cec8e81ecc1c15b63a0a1cfec311c5.png', null, 'png', '275474', '1528269069');
...
INSERT INTO `ykb_user` VALUES ('4', null, 'e10adc3949ba59abbe56e057f20f883e', '/uploads/home/20180606/a3cec8e81ecc1c15b63a0a1cfec311c5.png', 'chen', 'chen@qq.com', null, '0', null, '1', '1', '1528269000', '1528269048', '127.0.0.1');
INSERT INTO `ykb_user` VALUES ('5', null, 'e10adc3949ba59abbe56e057f20f883e', null, '123456', 'admin@qq.com', null, '0', null, '1', '1', '1528274749', '1528274760', '127.0.0.1');
